...
- Treat missing or failed deploy-report `env_validation`, including absent SRS §3.4.6 declared-key coverage, as a malformed environment and route back to DevOps; never infer local `.env` behavior during QA.
